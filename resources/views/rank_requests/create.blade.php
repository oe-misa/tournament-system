<x-app-layout>
    <div class="hub-page-narrow space-y-6">
        ...
        <div class="heian-card p-6 space-y-5">
            ...
            <div id="rankPreview" class="hidden rounded-md border border-[#e6ded2] bg-[#faf7f1] p-4 text-sm text-[#34251f]">
            ...
            <form method="POST" action="{{ route('rank_requests.store') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <select id="requested_rank_id" name="requested_rank_id" class="mt-1 w-full" required>
